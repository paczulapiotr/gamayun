...
namespace Tests
{
    ...
    public class GridQueryHandlerTests
    {
        ...
        private readonly static AppUser user1 = new AppUser { FirstName = "Mark", LastName = "Smith", Email = "marksmith@local.host" };
        private readonly static AppUser user2 = new AppUser { FirstName = "Markov", LastName = "Smarkovsky", Email = "markovsmarkovsky@local.host" };
        private readonly static AppUser user3 = new AppUser { FirstName = "Daniel", LastName = "Smirnov", Email = "danielsmirnov@local.host" };
        private readonly static AppUser user4 = new AppUser { FirstName = "Anna", LastName = "Ann", Email = "annaann@local.host" };
        private readonly static AppUser user5 = new AppUser { FirstName = "Jessica", LastName = "Brown", Email = "jessicabrown@local.host" };

        private readonly static Teacher _teacher1 = new Teacher { AppUser = user1, AppUserID = user1.Id };
        private readonly static Teacher _teacher2 = new Teacher { AppUser = user2, AppUserID = user2.Id };
        private readonly static Teacher _teacher3 = new Teacher { AppUser = user3, AppUserID = user3.Id };
        private readonly static Teacher _teacher4 = new Teacher { AppUser = user4, AppUserID = user4.Id };
        private readonly static Teacher _teacher5 = new Teacher { AppUser = user5, AppUserID = user5.Id };
